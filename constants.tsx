...
// Using SVG icons directly to avoid external dependencies for icons if not strictly needed, 
// ensuring high performance and self-containment.
export const Icons = {
  Camera: () => (
